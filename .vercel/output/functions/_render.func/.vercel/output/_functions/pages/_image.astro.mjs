import { A as AstroError, z as NoImageMetadata, F as FailedToFetchRemoteImageDimensions, B as ExpectedImageOptions, D as ExpectedImage, H as ExpectedNotESMImage, J as resolveSrc, K as isRemoteImage, Q as isRemotePath, T as isESMImportedImage, U as isLocalService, V as DEFAULT_HASH_PROPS, W as InvalidImageService, X as ImageMissingAlt, Y as isRemoteAllowed } from "../chunks/astro/assets-service_DOCCRJ5G.mjs";
import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, z as addAttribute, C as spreadAttributes } from "../chunks/astro/server_B4P9r3Vy.mjs";
import "clsx";
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      "../chunks/astro/assets-service_DOCCRJ5G.mjs"
    ).then((n) => n.Z).catch((e) => {
...
const $$Astro$1 = createAstro("https://vercel.johnnydecimal.com");
...
}, "/Users/john/dev/decimal.business/astro-clerk-vercel/node_modules/astro/components/Image.astro", void 0);
const $$Astro = createAstro("https://vercel.johnnydecimal.com");
...
}, "/Users/john/dev/decimal.business/astro-clerk-vercel/node_modules/astro/components/Picture.astro", void 0);
